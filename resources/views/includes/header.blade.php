<header class="tm-header" id="tm-header">
        <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav">            
                <ul>
                    <li class="tm-nav-item {{ request()->routeIs('index') ? 'active' : '' }}"><a href="{{ Route ('index') }}" class="tm-nav-link ">
                        <i class="fas fa-home"></i>
                        Blog Home
                    </a></li>
                    <li class="tm-nav-item {{ Route::is('post/{id}') ? 'active' : '' }}"><a href="{{  Route ('createpost') }}" class="tm-nav-link"> 
